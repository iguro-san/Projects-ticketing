...
<div class="bg-white rounded-lg shadow p-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Monitoring semua event yang dibuat oleh panitia</p>
        </div>
    </div>
                ...
                <tr class="hover:bg-gray-50 transition">
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-400">
                                    <i class="fas fa-map-marker-alt mr-1"></i>{{ Str::limit($event->location, 25) }}
                                </p>
                            </div>
                        </div>
                    </td>
                    ...
                    <td class="px-4 py-3 text-center">
                        ...
                        @elseif($event->status == 'completed' || ($event->status == 'active' && $event->event_date < now()))
                            <span class="px-2 py-1 bg-blue-100 text-blue-700 rounded-full text-xs font-semibold">
                                <i class="fas fa-hourglass-end mr-1"></i>Berakhir
                            </span>

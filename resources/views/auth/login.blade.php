...
=======
                <div class="bg-[#141E46] w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-4">
                    <i class="fas fa-calendar-alt text-3xl text-[#B6771D]"></i>
>>>>>>> 9666e08164e3298619e586825b3bbff6f6f440b2
            ...
            <form action="{{ route('login') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <div class="text-right mt-1">
                        <a href="{{ route('password.request') }}" class="text-xs text-[#B6771D] hover:text-[#B6771D]/80 transition">
                            Lupa Password?
                        </a>
                    </div>
                </div>
            ...
            <div class="mt-6 text-center">
                <p class="text-gray-600">
                    Belum punya akun? 
                    <a href="{{ route('register') }}" class="text-[#B6771D] font-semibold hover:text-[#B6771D]/80">
                        Daftar sekarang
                    </a>
                </p>
            </div>
            ...
            <div class="mt-8 p-4 bg-gray-50 rounded-lg">
                <h3 class="text-sm font-semibold mb-3 text-gray-700 flex items-center">
                    <i class="fas fa-info-circle mr-2 text-[#B6771D]"></i>
                    Akun Demo:
                </h3>

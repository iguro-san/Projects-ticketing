    ...
    <form action="{{ route('panitia.events.update', $event) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            ...
            <textarea name="description" rows="5" 
                      class="w-full border rounded-lg px-3 py-2 focus:outline-none focus:border-purple-600" required>{{ old('description', $event->description) }}</textarea>
        </div>
        ...
        <div class="flex gap-3">
            ...
            <a href="{{ route('panitia.events.index') }}" class="flex-1 bg-gray-300 text-gray-700 text-center py-2 rounded-lg hover:bg-gray-400 transition">
